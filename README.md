...
<p>Пример детекции с определением поз:</p>
<img src="assets/issue_result.png" alt="Пример: определение поз" width="100%">
...
## Pose-режим — проблемные случаи

1. **Устранение ложных срабатываний**
  <p>Куртка на стуле больше не принимается за человека</p>


2. **Потеря мелких и дальних людей**
<p>Далёкие или перекрытые люди не проходят pose-валидацию:</p>
<img src="assets/pose_small_vs_poster.png" width="50%">
